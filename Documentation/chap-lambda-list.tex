...
This rule defines a specialized lambda list as a mandatory instance of
the grammar-symbol class named
\texttt{specialized-required-parameter-group}, followed by optional
instances of the grammar-symbol classes
\texttt{ordinary-optional-parameter-group},
\texttt{ordinary-rest-parameter-group},
\texttt{ordinary-key-parameter-group}, and
...
This rule defines a defsetf lambda list as a mandatory instance of
the grammar-symbol class named
\texttt{ordinary-required-parameter-group}, followed by optional
instances of the grammar-symbol classes
\texttt{ordinary-optional-parameter-group},
\texttt{ordinary-rest-parameter-group},
\texttt{ordinary-key-parameter-group}, and
\texttt{environment-parameter-group} in that order.
