(cl:defpackage #:concrete-syntax-tree.tools.write-news
  (:use
   #:cl)

  (:import-from #:concrete-syntax-tree.tools.read-changes
   #:punctuationp
   #:split-into-lines)
...
(cl:in-package #:concrete-syntax-tree.tools.write-news)
